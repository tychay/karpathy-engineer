...
- `skills/karpathy-coder/scripts/complexity_checker.py`
- `skills/karpathy-coder/scripts/diff_surgeon.py`
- `skills/karpathy-coder/scripts/assumption_linter.py`
- `skills/karpathy-coder/scripts/goal_verifier.py`
